...
const CoinbasePro = () => {
  ...
  const openCoinbaseProModal = () => {
    return (
      <>
        <Button variant="outline-dark" style={{borderColor:"#272A3E",width:"100%",textAlign:"left", color:"white"}} onClick={handleShow}>
            &nbsp;
            <img
  ...
  return (
    <div className="App">        
      <div>
        {!authorized && 
        <div>{openCoinbaseProModal()}</div>}
      </div>

      {authorized && (
        <Button variant="outline-dark" style={{borderColor:"#272A3E",width:"100%",padding:"0px",textAlign:"left"}}>
        &nbsp;
        <img
                src={`https://play-lh.googleusercontent.com/hi0SSeYyAbDcl1UTDVit1Or4noRiBwuNi-rAZ6QAEnGFQcZDZEIMKYkH5pbY5fn4SA`}
                height="28px"
